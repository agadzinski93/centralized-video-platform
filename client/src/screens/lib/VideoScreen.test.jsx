...
beforeAll(()=>{
    ...
    vitest.mock('react-router-dom', async () => {
        ...
        return ({
            ...props,
            useParams: () => {
                let mockParams = {topic: "Java-Programming", video: "N8LDSryePuc"};
                return mockParams;
            }
        })
    });
...
test('Test Video Page Loaded Content', async () => {
    const {preloadedContainer} = render(<Provider store={store}><VideoScreen /></Provider>,{wrapper: BrowserRouter});
