...
export class ApiResponse {
    ...
    #prevPath: string;
    #data: object;
    constructor(response: string, status: number, message: string, prevPath: string = '/', data: object = {}) {
    ...
    setApiResponse(response: string, status: number, message: string, prevPath: string = '/', data: object = {}): void {
        this.#response = response;
        this.#status = status;
        this.#message = message;
        this.#prevPath = prevPath;
